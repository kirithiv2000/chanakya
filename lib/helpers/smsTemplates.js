...
smsTemplates.assignWorkSMS = `Dear {{=it.assignUser}} aapko {{=it.owner}} ne '{{=it.name}}' nam ke student ka {{=it.stage}} assign kiya hai. student ko contact karneke liye

{{=it.mobile}} mobile number par call kare. Aap ese jald se jald complete karke {{=it.owner}} ko update kar do. for more details go with this link

http://admissions.navgurukul.org/tasks
...
module.exports = {
  ...
  assignWorkSMS: dot.template(smsTemplates.assignWorkSMS),
};
