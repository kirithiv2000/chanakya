...
const {
  ...
  feedbackableStagesData, contact_type
} = commonConnfig;
...
module.exports = {
  ...
  questions: {
    pdf: {
      ...
      weeklyStudentsReportTemplate: `${__dirname}/helpers/templates/weeklyStudentsReportPdf.html`,
